...
> Don’t see your language in the above table or you’d like to contribute to an existing translation? You can help us translate the course by following the instructions [here](https://github.com/huggingface/course#translating-the-course-into-your-language).
...
[ Update on GitHub](https://github.com/huggingface/course/blob/main/chapters/en/chapter1/1.mdx)

[←Introduction](/learn/llm-course/chapter0/1) [Natural Language Processing and Large Language Models→](/learn/llm-course/chapter1/2)

[Introduction](#introduction)[Welcome to the 🤗 Course!](#welcome-to-the-course)[Understanding NLP and LLMs](#understanding-nlp-and-llms)[What to expect?](#what-to-expect)[Who are we?](#who-are-we)[FAQ](#faq)[Languages and translations](#languages-and-translations)[Let’s go 🚀](#lets-go-)
