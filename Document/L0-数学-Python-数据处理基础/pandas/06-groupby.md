...
# Group by: split-apply-combine[#](#group-by-split-apply-combine "Link to this heading")
...
## Splitting an object into groups[#](#splitting-an-object-into-groups "Link to this heading")
...
### GroupBy sorting[#](#groupby-sorting "Link to this heading")
...
#### GroupBy dropna[#](#groupby-dropna "Link to this heading")
...
### GroupBy object attributes[#](#groupby-object-attributes "Link to this heading")
...
### GroupBy with MultiIndex[#](#groupby-with-multiindex "Link to this heading")
...
### Grouping DataFrame with Index levels and columns[#](#grouping-dataframe-with-index-levels-and-columns "Link to this heading")
...
### DataFrame column selection in GroupBy[#](#dataframe-column-selection-in-groupby "Link to this heading")
...
## Selecting a group[#](#selecting-a-group "Link to this heading")
...
### Built-in aggregation methods[#](#built-in-aggregation-methods "Link to this heading")
...
### The [`aggregate()`](../reference/api/pandas.api.typing.DataFrameGroupBy.aggregate.html#pandas.api.typing.DataFrameGroupBy.aggregate "pandas.api.typing.DataFrameGroupBy.aggregate") method[#](#the-aggregate-method "Link to this heading")
...
### Aggregation with user-defined functions[#](#aggregation-with-user-defined-functions "Link to this heading")
...
### Applying multiple functions at once[#](#applying-multiple-functions-at-once "Link to this heading")
...
### Named aggregation[#](#named-aggregation "Link to this heading")
...
### Applying different functions to DataFrame columns[#](#applying-different-functions-to-dataframe-columns "Link to this heading")
...
### Built-in transformation methods[#](#built-in-transformation-methods "Link to this heading")
...
### The [`transform()`](../reference/api/pandas.api.typing.DataFrameGroupBy.transform.html#pandas.api.typing.DataFrameGroupBy.transform "pandas.api.typing.DataFrameGroupBy.transform") method[#](#the-transform-method "Link to this heading")

Similar to the [aggregation method](#groupby-aggregate-agg), the [`transform()`](../reference/api/pandas.api.typing.DataFrameGroupBy.transform.html#pandas.api.typing.DataFrameGroupBy.transform "pandas.api.typing.DataFrameGroupBy.transform") method can accept string aliases to the built-in transformation methods in the previous section. It can _also_ accept string aliases to the built-in aggregation methods. When an aggregation method is provided, the result will be broadcast across the group.
...
All of the examples in this section can be made more performant by calling built-in methods instead of using UDFs. See [below for examples](#groupby-efficient-transforms).
...
Similar to [The aggregate() method](#groupby-aggregate-agg), the resulting dtype will reflect that of the transformation function. If the results from different groups have different dtypes, then a common dtype will be determined in the same way as `DataFrame` construction.
...
### Window and resample operations[#](#window-and-resample-operations "Link to this heading")
...
## Filtration[#](#filtration "Link to this heading")
...
### Built-in filtrations[#](#built-in-filtrations "Link to this heading")
...
### The `filter` method[#](#the-filter-method "Link to this heading")
...
## Flexible `apply`[#](#flexible-apply "Link to this heading")
...
Similar to [The aggregate() method](#groupby-aggregate-agg), the resulting dtype will reflect that of the apply function. If the results from different groups have different dtypes, then a common dtype will be determined in the same way as `DataFrame` construction.

### Control grouped column(s) placement with `group_keys`[#](#control-grouped-column-s-placement-with-group-keys "Link to this heading")
...
## Numba accelerated routines[#](#numba-accelerated-routines "Link to this heading")
...
## Other useful features[#](#other-useful-features "Link to this heading")

### Exclusion of non-numeric columns[#](#exclusion-of-non-numeric-columns "Link to this heading")
...
### Handling of (un)observed Categorical values[#](#handling-of-un-observed-categorical-values "Link to this heading")
...
### NA group handling[#](#na-group-handling "Link to this heading")
...
### Grouping with ordered factors[#](#grouping-with-ordered-factors "Link to this heading")
...
### Grouping with a grouper specification[#](#grouping-with-a-grouper-specification "Link to this heading")
...
### Taking the first rows of each group[#](#taking-the-first-rows-of-each-group "Link to this heading")
...
### Taking the nth row of each group[#](#taking-the-nth-row-of-each-group "Link to this heading")
...
### Enumerate group items[#](#enumerate-group-items "Link to this heading")
...
### Enumerate groups[#](#enumerate-groups "Link to this heading")
...
### Piping function calls[#](#piping-function-calls "Link to this heading")
...
### Multi-column factorization[#](#multi-column-factorization "Link to this heading")
...
### GroupBy by indexer to ‘resample’ data[#](#groupby-by-indexer-to-resample-data "Link to this heading")
...
### Returning a Series to propagate names[#](#returning-a-series-to-propagate-names "Link to this heading")
...
[ __ previous User-Defined Functions (UDFs) ](user_defined_functions.html "previous page") [ next Windowing operations __](window.html "next page")
...
__On this page
  ...
  * [Splitting an object into groups](#splitting-an-object-into-groups)
    ...
    * [Grouping DataFrame with Index levels and columns](#grouping-dataframe-with-index-levels-and-columns)
  ...
  * [Aggregation](#aggregation)
    * [Built-in aggregation methods](#built-in-aggregation-methods)
    * [The `aggregate()` method](#the-aggregate-method)
    * [Aggregation with user-defined functions](#aggregation-with-user-defined-functions)
  ...
  * [Transformation](#transformation)
    * [Built-in transformation methods](#built-in-transformation-methods)
    * [The `transform()` method](#the-transform-method)
    * [Window and resample operations](#window-and-resample-operations)
  * [Filtration](#filtration)
    * [Built-in filtrations](#built-in-filtrations)
    * [The `filter` method](#the-filter-method)
  * [Flexible `apply`](#flexible-apply)
    * [Control grouped column(s) placement with `group_keys`](#control-grouped-column-s-placement-with-group-keys)
  * [Numba accelerated routines](#numba-accelerated-routines)
  * [Other useful features](#other-useful-features)
    * [Exclusion of non-numeric columns](#exclusion-of-non-numeric-columns)
    * [Handling of (un)observed Categorical values](#handling-of-un-observed-categorical-values)
    * [NA group handling](#na-group-handling)
  ...
  * [Examples](#examples)
    * [Multi-column factorization](#multi-column-factorization)
    * [GroupBy by indexer to ‘resample’ data](#groupby-by-indexer-to-resample-data)
