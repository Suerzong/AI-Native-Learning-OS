...
# Indexing and selecting data[#](#indexing-and-selecting-data "Link to this heading")
...
## Different choices for indexing[#](#different-choices-for-indexing "Link to this heading")
...
> 
>     * A slice object with labels `'a':'f'` (Note that contrary to usual Python slices, **both** the start and the stop are included, when present in the index! See [Slicing with labels](#indexing-slicing-with-labels) and [Endpoints are inclusive](advanced.html#advanced-endpoints-are-inclusive).)
> 
...
See more at [Selection by Position](#indexing-integer), [Advanced Indexing](advanced.html#advanced) and [Advanced Hierarchical](advanced.html#advanced-advanced-hierarchical).
...
## Attribute access[#](#attribute-access "Link to this heading")
...
## Slicing ranges[#](#slicing-ranges "Link to this heading")

The most robust and consistent way of slicing ranges along arbitrary axes is described in the [Selection by Position](#indexing-integer) section detailing the `.iloc` method. For now, we explain the semantics of slicing using the `[]` operator.
...
## Selection by label[#](#selection-by-label "Link to this heading")
...
The `.loc` attribute is the primary access method. The following are valid inputs:
  ...
  * A slice object with labels `'a':'f'`. Note that contrary to usual Python slices, **both** the start and the stop are included, when present in the index! See [Slicing with labels](#indexing-slicing-with-labels).
...
### Slicing with labels[#](#slicing-with-labels "Link to this heading")
...
## Selection by position[#](#selection-by-position "Link to this heading")
...
## Selection by callable[#](#selection-by-callable "Link to this heading")
...
## Combining positional and label-based indexing[#](#combining-positional-and-label-based-indexing "Link to this heading")
...
### Reindexing[#](#reindexing "Link to this heading")
...
## Selecting random samples[#](#selecting-random-samples "Link to this heading")
...
## Setting with enlargement[#](#setting-with-enlargement "Link to this heading")
...
## Fast scalar value getting and setting[#](#fast-scalar-value-getting-and-setting "Link to this heading")
...
## Boolean indexing[#](#boolean-indexing "Link to this heading")
...
With the choice methods [Selection by Label](#indexing-label), [Selection by Position](#indexing-integer), and [Advanced Indexing](advanced.html#advanced) you may select along more than one axis using boolean vectors combined with other indexing expressions.
...
## Indexing with isin[#](#indexing-with-isin "Link to this heading")
...
## The [`where()`](../reference/api/pandas.DataFrame.where.html#pandas.DataFrame.where "pandas.DataFrame.where") Method and Masking[#](#the-where-method-and-masking "Link to this heading")
...
## Setting with enlargement conditionally using `numpy()`[#](#setting-with-enlargement-conditionally-using-numpy "Link to this heading")
...
## The [`query()`](../reference/api/pandas.DataFrame.query.html#pandas.DataFrame.query "pandas.DataFrame.query") Method[#](#the-query-method "Link to this heading")
...
### [`MultiIndex`](../reference/api/pandas.MultiIndex.html#pandas.MultiIndex "pandas.MultiIndex") [`query()`](../reference/api/pandas.DataFrame.query.html#pandas.DataFrame.query "pandas.DataFrame.query") Syntax[#](#multiindex-query-syntax "Link to this heading")
...
### [`query()`](../reference/api/pandas.DataFrame.query.html#pandas.DataFrame.query "pandas.DataFrame.query") Use Cases[#](#query-use-cases "Link to this heading")
...
### [`query()`](../reference/api/pandas.DataFrame.query.html#pandas.DataFrame.query "pandas.DataFrame.query") Python versus pandas Syntax Comparison[#](#query-python-versus-pandas-syntax-comparison "Link to this heading")
...
### The `in` and `not in` operators[#](#the-in-and-not-in-operators "Link to this heading")
...
### Special use of the `==` operator with `list` objects[#](#special-use-of-the-operator-with-list-objects "Link to this heading")
...
### Boolean operators[#](#boolean-operators "Link to this heading")
...
### Performance of [`query()`](../reference/api/pandas.DataFrame.query.html#pandas.DataFrame.query "pandas.DataFrame.query")[#](#performance-of-query "Link to this heading")

`DataFrame.query()` using `numexpr` is slightly faster than Python for large frames.

![../_images/query-perf.png](../_images/query-perf.png)
...
## Duplicate data[#](#duplicate-data "Link to this heading")
...
## Dictionary-like [`get()`](../reference/api/pandas.DataFrame.get.html#pandas.DataFrame.get "pandas.DataFrame.get") method[#](#dictionary-like-get-method "Link to this heading")
...
## Looking up values by index/column labels[#](#looking-up-values-by-index-column-labels "Link to this heading")
...
## Index objects[#](#index-objects "Link to this heading")
...
### Setting metadata[#](#setting-metadata "Link to this heading")
...
### Set operations on Index objects[#](#set-operations-on-index-objects "Link to this heading")
...
## Set / reset index[#](#set-reset-index "Link to this heading")

Occasionally you will load or create a data set into a DataFrame and want to add an index after you’ve already done so. There are a couple of different ways.

### Set an index[#](#set-an-index "Link to this heading")
...
### Reset the index[#](#reset-the-index "Link to this heading")
...
### Adding an ad hoc index[#](#adding-an-ad-hoc-index "Link to this heading")
...
### Why does assignment fail when using chained indexing?[#](#why-does-assignment-fail-when-using-chained-indexing "Link to this heading")
...
## Series Assignment and Index Alignment[#](#series-assignment-and-index-alignment "Link to this heading")
...
### Key Points:[#](#key-points "Link to this heading")
...
[ __ previous PyArrow Functionality ](pyarrow.html "previous page") [ next MultiIndex / advanced indexing __](advanced.html "next page")

__On this page

  * [Different choices for indexing](#different-choices-for-indexing)
  * [Basics](#basics)
  ...
  * [Combining positional and label-based indexing](#combining-positional-and-label-based-indexing)
  ...
  * [The `where()` Method and Masking](#the-where-method-and-masking)
    * [Mask](#mask)
  * [Setting with enlargement conditionally using `numpy()`](#setting-with-enlargement-conditionally-using-numpy)
  * [The `query()` Method](#the-query-method)
    ...
    * [Performance of `query()`](#performance-of-query)
  * [Duplicate data](#duplicate-data)
  * [Dictionary-like `get()` method](#dictionary-like-get-method)
  * [Looking up values by index/column labels](#looking-up-values-by-index-column-labels)
  * [Index objects](#index-objects)
    * [Setting metadata](#setting-metadata)
    * [Set operations on Index objects](#set-operations-on-index-objects)
    * [Missing values](#missing-values)
  * [Set / reset index](#set-reset-index)
    * [Set an index](#set-an-index)
    * [Reset the index](#reset-the-index)
    * [Adding an ad hoc index](#adding-an-ad-hoc-index)
    * [Why does assignment fail when using chained indexing?](#why-does-assignment-fail-when-using-chained-indexing)
  * [Series Assignment and Index Alignment](#series-assignment-and-index-alignment)
