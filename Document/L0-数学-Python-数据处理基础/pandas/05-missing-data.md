...
# Working with missing data[#](#working-with-missing-data "Link to this heading")

## Values considered “missing”[#](#values-considered-missing "Link to this heading")
...
## [`NA`](../reference/api/pandas.NA.html#pandas.NA "pandas.NA") semantics[#](#na-semantics "Link to this heading")
...
An exception on this basic propagation rule are _reductions_ (such as the mean or the minimum), where pandas defaults to skipping missing values. See the [calculation section](#missing-data-calculations) for more.

### Logical operations[#](#logical-operations "Link to this heading")
...
### `NA` in a boolean context[#](#na-in-a-boolean-context "Link to this heading")
...
### NumPy ufuncs[#](#numpy-ufuncs "Link to this heading")
...
## Inserting missing data[#](#inserting-missing-data "Link to this heading")
...
## Calculations with missing data[#](#calculations-with-missing-data "Link to this heading")
...
## Dropping missing data[#](#dropping-missing-data "Link to this heading")
...
## Filling missing data[#](#filling-missing-data "Link to this heading")

### Filling by value[#](#filling-by-value "Link to this heading")
...
![../_images/series_before_interpolate.png](../_images/series_before_interpolate.png)
...
![../_images/series_interpolate.png](../_images/series_interpolate.png)
...
![../_images/compare_interpolations.png](../_images/compare_interpolations.png)
...
#### Interpolation limits[#](#interpolation-limits "Link to this heading")
...
### Replacing values[#](#replacing-values "Link to this heading")
...
#### Regular expression replacement[#](#regular-expression-replacement "Link to this heading")
...
[ __ previous Working with text data ](text.html "previous page") [ next Duplicate Labels __](duplicates.html "next page")

__On this page

  * [Values considered “missing”](#values-considered-missing)
  * [`NA` semantics](#na-semantics)
    * [Propagation in arithmetic and comparison operations](#propagation-in-arithmetic-and-comparison-operations)
    * [Logical operations](#logical-operations)
    * [`NA` in a boolean context](#na-in-a-boolean-context)
    * [NumPy ufuncs](#numpy-ufuncs)
      * [Conversion](#conversion)
  * [Inserting missing data](#inserting-missing-data)
  * [Calculations with missing data](#calculations-with-missing-data)
  * [Dropping missing data](#dropping-missing-data)
  * [Filling missing data](#filling-missing-data)
    * [Filling by value](#filling-by-value)
