...
[ __Colab [mxnet]](https://colab.research.google.com/github/d2l-ai/d2l-zh-colab/blob/master/chapter_preliminaries/pandas.ipynb)

Open the notebook in Colab

[ __Colab [pytorch]](https://colab.research.google.com/github/d2l-ai/d2l-zh-pytorch-colab/blob/master/chapter_preliminaries/pandas.ipynb)

Open the notebook in Colab

[ __Colab [tensorflow]](https://colab.research.google.com/github/d2l-ai/d2l-zh-tensorflow-colab/blob/master/chapter_preliminaries/pandas.ipynb)

Open the notebook in Colab

[ __Colab [paddle]](https://colab.research.google.com/github/d2l-ai/d2l-zh-paddle-colab/blob/master/chapter_preliminaries/pandas.ipynb)
...
注意，“NaN”项代表缺失值。 为了处理缺失的数据，典型的方法包括 _插值法_ 和 _删除法_ ， 其中插值法用一个替代值弥补缺失值，而删除法则直接忽略缺失值。 在这里，我们将考虑插值法。
