...
[Go to the end](#sphx-glr-download-intermediate-seq2seq-translation-tutorial-py) to download the full example code.

# NLP From Scratch: Translation with a Sequence to Sequence Network and Attention[#](#nlp-from-scratch-translation-with-a-sequence-to-sequence-network-and-attention "Link to this heading")
...
You will also find the previous tutorials on [NLP From Scratch: Classifying Names with a Character-Level RNN](char_rnn_classification_tutorial.html) and [NLP From Scratch: Generating Names with a Character-Level RNN](char_rnn_generation_tutorial.html) helpful as those concepts are very similar to the Encoder and Decoder models, respectively.
...
## Loading data files[#](#loading-data-files "Link to this heading")
...
## The Seq2Seq Model[#](#the-seq2seq-model "Link to this heading")
...
### The Encoder[#](#the-encoder "Link to this heading")
...
### The Decoder[#](#the-decoder "Link to this heading")

The decoder is another RNN that takes the encoder output vector(s) and outputs a sequence of words to create the translation.

#### Simple Decoder[#](#simple-decoder "Link to this heading")
...
#### Attention Decoder[#](#attention-decoder "Link to this heading")
...
### Preparing Training Data[#](#preparing-training-data "Link to this heading")
...
### Plotting results[#](#plotting-results "Link to this heading")
...
## Training and Evaluating[#](#training-and-evaluating "Link to this heading")
...
If you run this notebook you can train, interrupt the kernel, evaluate, and continue training later. Comment out the lines where the encoder and decoder are initialized and run `trainIters` again.
  ...
  * ![seq2seq translation tutorial](../_images/sphx_glr_seq2seq_translation_tutorial_001.png)
  * ![seq2seq translation tutorial](../_images/sphx_glr_seq2seq_translation_tutorial_002.png)
    ...
    fra 4601
    eng 2991
    0m 31s (- 7m 55s) (5 6%) 1.5461
    1m 3s (- 7m 21s) (10 12%) 0.6865
    1m 34s (- 6m 49s) (15 18%) 0.3596
    2m 5s (- 6m 17s) (20 25%) 0.1996
    2m 37s (- 5m 45s) (25 31%) 0.1226
    3m 8s (- 5m 14s) (30 37%) 0.0849
    3m 39s (- 4m 42s) (35 43%) 0.0646
    4m 11s (- 4m 11s) (40 50%) 0.0531
    4m 43s (- 3m 40s) (45 56%) 0.0455
    5m 14s (- 3m 8s) (50 62%) 0.0406
    5m 45s (- 2m 37s) (55 68%) 0.0371
    6m 17s (- 2m 5s) (60 75%) 0.0345
    6m 48s (- 1m 34s) (65 81%) 0.0331
    7m 19s (- 1m 2s) (70 87%) 0.0316
    7m 51s (- 0m 31s) (75 93%) 0.0305
    8m 22s (- 0m 0s) (80 100%) 0.0292
...
Set dropout layers to `eval` mode
    ...
    < i m breaking in my new shoes <EOS>

    > il est en danger grave
    = he s in grave danger
    < he s in grave danger <EOS>
    ...
    < she s starting to annoy me <EOS>

    > je ne suis pas convaincue
    = i m not convinced
    < i m not convinced of energy <EOS>
...
### Visualizing Attention[#](#visualizing-attention "Link to this heading")
...
You could simply run `plt.matshow(attentions)` to see attention output displayed as a matrix. For a better viewing experience we will do the extra work of adding axes and labels:
  ...
  * ![seq2seq translation tutorial](../_images/sphx_glr_seq2seq_translation_tutorial_003.png)
  * ![seq2seq translation tutorial](../_images/sphx_glr_seq2seq_translation_tutorial_004.png)
  * ![seq2seq translation tutorial](../_images/sphx_glr_seq2seq_translation_tutorial_005.png)
  * ![seq2seq translation tutorial](../_images/sphx_glr_seq2seq_translation_tutorial_006.png)
...
**Total running time of the script:** (8 minutes 31.036 seconds)
