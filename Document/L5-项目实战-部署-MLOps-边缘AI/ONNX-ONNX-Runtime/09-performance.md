...
## Table of contents
  ...
  * [End to end optimization with Olive](/docs/performance/olive.html)
  * [Device tensors](/docs/performance/device-tensor.html)
  * [Tune Mobile Performance (ORT <1.10 only)](/docs/performance/mobile-performance-tuning.html)
...
[Edit this page on GitHub](https://github.com/microsoft/onnxruntime/tree/gh-pages/docs/performance/index.md)
