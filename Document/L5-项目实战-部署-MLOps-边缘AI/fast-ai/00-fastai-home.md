...
__
  ...
  1. [Practical Deep Learning](./index.html)
...
[Practical Deep Learning for Coders part 2: _Deep Learning Foundations to Stable Diffusion_](./Lessons/part2.html)
...
There are 9 lessons, and each lesson is around 90 minutes long. The course is based on our [5-star rated book](https://www.amazon.com/Deep-Learning-Coders-fastai-PyTorch/dp/1492045527), which is [freely available](./Resources/book.html) online.
...
Start watching [lesson 1](./Lessons/lesson1.html) now!

## Real results

Our videos have been viewed over 6,000,000 times already! Take a look at the [dozens of testimonials](./Resources/testimonials.html) about our book and course by alumni, top academics, and industry experts.
...
To watch the videos, click on the _Lessons_ section in the navigation sidebar. The videos are all captioned; while watching the video click the “CC” button to turn them on and off. To get a sense of what’s covered in a lesson, you might want to skim through some lesson notes taken by one of our students (thanks Daniel!). Here’s his [lesson 7 notes](./Lessons/Summaries/lesson7.html) and [lesson 8 notes](./Lessons/Summaries/lesson8.html). You can also access all the videos through [this YouTube playlist](https://www.youtube.com/playlist?list=PLfYUBJiXbdtSvpQjSnJJ_PmDQB_VyT5iU).
...
[ 1: Getting started __](./Lessons/lesson1.html)
