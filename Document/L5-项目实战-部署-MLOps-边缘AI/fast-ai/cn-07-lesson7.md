...
您几乎每天都会与推荐系统互动，这些算法会根据您过去的行为猜测您可能喜欢哪些产品和服务。这些系统很大程度上依赖于“协作过滤”，这是一种基于线性代数的方法，可填充矩阵中的缺失值。今天我们将看到两种方法来做到这一点：一种基于经典的线性代数公式，另一种基于深度学习。

＃＃ 视频

本课程部分基于[书](https://www.amazon.com/Deep-Learning-Coders-fastai-PyTorch/dp/1492045527)的[第8章](https://github.com/fastai/fastbook/blob/master/08_collab.ipynb)。

＃＃ 资源

  * 本课笔记本：
    * 通往顶峰之路：[第 3 部分](https://www.kaggle.com/code/jhoward/scaling-up-road-to-the-top-part-3) 和 [第 4 部分](https://www.kaggle.com/code/jhoward/multi-target-road-to-the-top-part-4)
  ...
  * 本课的[电子表格](https://github.com/fastai/course22/tree/master/xl)：
    * [Softmax 和交叉熵](https://github.com/fastai/course22/blob/master/xl/entropy_example.xlsx)
    * [良好的过滤和嵌入](https://github.com/fastai/course22/blob/master/xl/collab_filter.xlsx)
  * [关于交叉熵让我困惑的事情](https://chris-said.io/2020/12/26/two-things-that-c​​onfused-me-about-cross-entropy/) 作者：Chris Said
  * [使用 Microsoft Excel 解释标签平滑](https://amaarora.github.io/posts/2020-07-18-label-smoothing.html) 作者：Aman Arora

[__ 6：随机森林](../Lessons/lesson6.html)

[8：心血管（CNN）__](../Lessons/lesson8.html)
