...
**[![dict_img_pos1](../_images/sphx_glr_plot_faces_decomposition_010.png)](<../auto_examples/decomposition/plot_faces_decomposition.html>)[![dict_img_pos2](../_images/sphx_glr_plot_faces_decomposition_011.png)](<../auto_examples/decomposition/plot_faces_decomposition.html>)**

**[![dict_img_pos3](../_images/sphx_glr_plot_faces_decomposition_012.png)](<../auto_examples/decomposition/plot_faces_decomposition.html>)[![dict_img_pos4](../_images/sphx_glr_plot_faces_decomposition_013.png)](<../auto_examples/decomposition/plot_faces_decomposition.html>)**
...
When modeling text corpora, the model assumes the following generative process for a corpus with \\(D\\) documents and \\(K\\) topics, with \\(K\\) corresponding to `n_components` in the API:
  ...
  3. For each word \\(n=1,\cdots,N_d\\) in document \\(d\\):
     ...
     1. Draw the topic assignment \\(z_{dn} \sim \mathrm{Multinomial} (\theta_d)\\)

     2. Draw the observed word \\(w_{dn} \sim \mathrm{Multinomial} (\beta_{z_{dn}})\\)
