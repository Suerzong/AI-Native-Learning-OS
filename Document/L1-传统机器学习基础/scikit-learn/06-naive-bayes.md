...
References#
  ...
  * A. McCallum and K. Nigam (1998). [A comparison of event models for Naive Bayes text classification.](<https://cdn.aaai.org/Workshops/1998/WS-98-05/WS98-05-007.pdf>) Proc. AAAI/ICML-98 Workshop on Learning for Text Categorization, pp. 41-48.

  * V. Metsis, I. Androutsopoulos and G. Paliouras (2006). [Spam filtering with Naive Bayes – Which Naive Bayes?](<https://www2.aueb.gr/users/ion/docs/ceas2006_paper.pdf>) 3rd Conf. on Email and Anti-Spam (CEAS).
