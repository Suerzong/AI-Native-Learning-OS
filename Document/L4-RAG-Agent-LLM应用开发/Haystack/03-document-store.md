...
🔍Search documentation...
  ...
  * [Haystack Concepts](</docs/concepts-overview>)
    ...
    * [Document Store](</docs/document-store>)
      ...
      * [Choosing a Document Store](</docs/choosing-a-document-store>)
...
### DocumentStore Protocol[​](<#documentstore-protocol> "Direct link to DocumentStore Protocol")
...
### Work with Documents[​](<#work-with-documents> "Direct link to Work with Documents")
...
### DuplicatePolicy[​](<#duplicatepolicy> "Direct link to DuplicatePolicy")
...
### Custom Document Store[​](<#custom-document-store> "Direct link to Custom Document Store")
...
[Edit this page](<https://github.com/deepset-ai/haystack/tree/main/docs-website/versioned_docs/version-2.28/concepts/document-store.mdx>)

[PreviousChatMessage](</docs/chatmessage>)[NextChoosing a Document Store](</docs/choosing-a-document-store>)

  * [DocumentStore Protocol](<#documentstore-protocol>)
  * [Initialization](<#initialization>)
  * [Work with Documents](<#work-with-documents>)
  * [DuplicatePolicy](<#duplicatepolicy>)
  * [Custom Document Store](<#custom-document-store>)
