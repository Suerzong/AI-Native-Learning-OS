...
Make your first API request in minutes. Learn the basics of the OpenAI platform.[Get started](</api/docs/quickstart>)[Create API key](<https://platform.openai.com/api-keys>)javascript
