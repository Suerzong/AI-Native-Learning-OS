...
## [](<#how-do-tools-work>) How do tools work?
...
## [](<#how-do-we-give-tools-to-an-llm>) How do we give tools to an LLM?
...
### [](<#auto-formatting-tool-sections>) Auto-formatting Tool sections
...
### [](<#generic-tool-implementation>) Generic Tool implementation
...
### [](<#model-context-protocol-mcp-a-unified-tool-interface>) Model Context Protocol (MCP): a unified tool interface
...
[ Update on GitHub](<https://github.com/huggingface/agents-course/blob/main/units/en/unit1/tools.mdx>)

[←Messages and Special Tokens](</learn/agents-course/unit1/messages-and-special-tokens>) [Quick Quiz 2→](</learn/agents-course/unit1/quiz2>)

[What are Tools?](<#what-are-tools>)[What are AI Tools?](<#what-are-ai-tools>)[How do tools work?](<#how-do-tools-work>)[How do we give tools to an LLM?](<#how-do-we-give-tools-to-an-llm>)[Auto-formatting Tool sections](<#auto-formatting-tool-sections>)[Generic Tool implementation](<#generic-tool-implementation>)[Model Context Protocol (MCP): a unified tool interface](<#model-context-protocol-mcp-a-unified-tool-interface>)
