...
[Frameworks for AI Agents](</learn/agents-course/unit2/introduction>)
...
## [](<#when-to-use-an-agentic-framework>) When to Use an Agentic Framework
...
## [](<#agentic-frameworks-units>) Agentic Frameworks Units
...
[ Update on GitHub](<https://github.com/huggingface/agents-course/blob/main/units/en/unit2/introduction.mdx>)

[←Conclusion](</learn/agents-course/unit1/conclusion>) [Introduction to smolagents→](</learn/agents-course/unit2/smolagents/introduction>)

[Introduction to Agentic Frameworks](<#introduction-to-agentic-frameworks>)[When to Use an Agentic Framework](<#when-to-use-an-agentic-framework>)[Agentic Frameworks Units](<#agentic-frameworks-units>)
