...
You can prompt [AI Studio Build](<https://aistudio.google.com/apps?e=0>) to create an app just like [this example transcription app](<https://aistudio.google.com/apps/bundled/echoscript>) , with the click of a button.
