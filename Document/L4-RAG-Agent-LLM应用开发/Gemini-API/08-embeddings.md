...
**Note:** While `gemini-embedding-001` lets you generate individual embeddings for a list of strings, Gemini Embedding 2 produces a single aggregated embedding for multiple inputs. You can find more information in [Embedding aggregation](<#embedding-aggregation>), or you can use the [Batch API](</gemini-api/docs/batch-api#batch-embedding>) if you want to generate multiple embeddings at once.
...
For `gemini-embedding-001`, you can specify the `task_type` in the `embedContent` method. For a complete list of supported task types, see the [Supported task types](<#supported-task-types>) table.
...
Images can be provided as inline data or as uploaded files through the [Files API](</gemini-api/docs/files>).
...
Audio files can be provided as inline data or as uploaded files through the [Files API](</gemini-api/docs/files>).
...
Videos can be provided as inline data or as uploaded files through the [Files API](</gemini-api/docs/files>).
...
PDFs can be provided as inline data or as uploaded files through the [Files API](</gemini-api/docs/files>).
...
token_autoToken limits[[*]](</gemini-api/docs/tokens>) |  **Input token limit** 8,192 **Output dimension size** Flexible, supports: 128 - 3072, Recommended: 768, 1536, 3072
...
token_autoToken limits[[*]](</gemini-api/docs/tokens>) |  **Input token limit** 2,048 **Output dimension size** Flexible, supports: 128 - 3072, Recommended: 768, 1536, 3072
123Versions |  Read the [model version patterns](</gemini-api/docs/models/gemini#model-versions>) for more details.
