## 说明
	...
	此为《人工智能入门实践》（肖波等著）7.3节代码，中文文本分类示例程序
        ...
        （1）教材7.3.1节的工作是得到训练、验证和测试文件，而这些文件在该目录中的data中已经为大家准备好:
        train.txt, dev.txt, test.txt
        因此，可忽略7.3.1节的代码执行，直接使用这些文件即可。当然，也可以执行相应代码，自己生成这些文件。

        （2）教材7.3.2节的工作是得到训练集中的所有字的嵌入向量，而这个文件在该目录中也已经为大家准备好:
        embedding_SougouNews.npz
	因此，也可忽略7.3.2节的代码执行，直接使用这个文件即可。当然，也可以执行相应代码，自己生成这个文件。
